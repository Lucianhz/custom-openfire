...
public class MUCPersistenceManager {
    ...
    private static final String LOAD_HISTORY =
        "SELECT sender, nickname, logTime, subject, body, expand FROM ofMucConversationLog " +
    ...
    private static final String LOAD_ALL_HISTORY =
        ...
        "ofMucConversationLog.logTime, ofMucConversationLog.subject, ofMucConversationLog.body, ofMucConversationLog.expand FROM " +
    ...
    private static final String ADD_CONVERSATION_LOG =
        "INSERT INTO ofMucConversationLog (roomID,sender,nickname,logTime,subject,body,expand) " +
        "VALUES (?,?,?,?,?,?,?)";
        ...
        try {
            ...
            while (resultSet.next()) {
                try {
                    ...
                    String expend	 = resultSet.getString(7);
                    room.getRoomHistory().addOldMessage(senderJID, nickname, sentDate, subject, body, expend);
                } catch (SQLException e) {
    ...
    public static boolean saveConversationLogEntry(ConversationLogEntry entry) {
        ...
        try {
            ...
            pstmt.setString(7, entry.getExpand());
            pstmt.executeUpdate();
            return true;
        }
        catch (SQLException sqle) {
